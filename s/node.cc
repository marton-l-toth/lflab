...
ndini_fun b_ar_init, b_noise_init, b_b0_init, b_help_init, b_in_init, b_map_init,
...
void Node::init() {
	...
	b_help_init(_b_help);
	B_INI(ar); B_INI(noise); B_INI(in); B_INI(map); b_b0_init(_b); b_filt_misc_init(_b_filt);
