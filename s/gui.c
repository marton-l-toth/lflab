...
{0, 10, 0,6,3, "->box edit/Tedit/Xfrom@lfrom@rhelp  help  info1 info4 delete","W$ EE ED EQ0EQ1$? N? I1 I4 Nd "},
...
"({80trg|$2Xzt}3{Y11$Xz1}{Y22$Xz2}{Y33$Xz3}{Y44$Xz4}{Y55$Xz5}{Y66$Xz6}{Y77$Xz7}{Y88$Xz8}{Y99$Xz9})",
...
static void acfg_skel (struct _topwin * tw, char * arg) {
	...
	"([3({!sspd$158As}{!rrsv$123Ar}{!aadj$1faAa}{!ttry$114At}{!wt/w$1faAw})0(3{L<88.8}{L_-}{L>88.8})]"
	"[{B_?$$?}{M_name:$An|_01}{en10$AN}{M_chan.c:$Ao|S2}{eo10$AO}{L##out: 0}(3{YB2^x$AB}{Mc$Ac|S1})"
	"(3{Y0susp PA$A0})(3{B_stop$AZ}{B_start$AR}){B_saveCfg$~c>}])]";
